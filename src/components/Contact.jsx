  ...
  return (
      ...
      >
          <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                  ...
                  <div className="flex mt-auto gap-2 items-center">
                      {
                          socialLinks.map(({ href, icon }, key) => (
                              <a
                                  ...
                                  href={href}
                                  target="_blank"
                                  className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 hover:bg-zinc-50/80 reveal-up"
                              >
                                  {icon}
                              </a>
                          ))
              ...
              <form
                  action="https://getform.io/f/agddngkb"
                  method="POST"
              ...
              >
                  <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                          ...
                          <input
                              ...
                              autoComplete="name"
                              required
                              placeholder="Devendra Mani Tripathi"
                              className="text-field" />
                        </div>
                        <div className="mb-4">
                          <label
                              htmlFor="email"
                              className="labelreveal-up"
                          >
                            Email
                          </label> 
                          <input
                  ...
                  <button
                      type="submit"
                      className="btn btn-primaryundefined [&]:max-w-full w-full justify-center reveal-up"
                  >
                      Submit
                      </button>
              </form>
